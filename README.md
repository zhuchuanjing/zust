...
The project is close to a mature open-source release. The workspace now contains separately versioned crates, with the VM crate at `0.9.21`, the dynamic crate at `0.9.5`, the compiler at `0.9.7`, the parser at `0.9.6`, and the editor-facing packages at `0.9.2`.
