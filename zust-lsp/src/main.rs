...
fn lsp_externs() -> Vec<LspExtern> {
    vec![
        ...
        LspExtern { full_name: "root::mount_fjall", arg_tys: vec![Type::Any, Type::Any], ret_ty: Type::Void },
        LspExtern { full_name: "root::mount_dir", arg_tys: vec![Type::Any, Type::Any], ret_ty: Type::Bool },
        ...
        LspExtern { full_name: "root::dir", arg_tys: vec![Type::Any, Type::Bool], ret_ty: Type::Any },
        LspExtern { full_name: "root::stat", arg_tys: vec![Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "root::read_text", arg_tys: vec![Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "root::write_text", arg_tys: vec![Type::Any, Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "root::search_text", arg_tys: vec![Type::Any, Type::Any, Type::Bool, Type::I64], ret_ty: Type::Any },
        LspExtern { full_name: "root::copy_file", arg_tys: vec![Type::Any, Type::Any], ret_ty: Type::Bool },
        LspExtern { full_name: "root::rename", arg_tys: vec![Type::Any, Type::Any], ret_ty: Type::Bool },
        LspExtern { full_name: "root::make_dir", arg_tys: vec![Type::Any], ret_ty: Type::Bool },
        LspExtern { full_name: "root::create_dir", arg_tys: vec![Type::Any], ret_ty: Type::Bool },
        LspExtern { full_name: "root::remove_dir", arg_tys: vec![Type::Any, Type::Bool], ret_ty: Type::Bool },
        ...
        LspExtern { full_name: "root::send_idx", arg_tys: vec![Type::Any, Type::I64, Type::Any], ret_ty: Type::Any },
        ...
        LspExtern { full_name: "process::run", arg_tys: vec![Type::Any, Type::Any, Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "process::spawn", arg_tys: vec![Type::Any, Type::Any, Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "process::poll", arg_tys: vec![Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "process::terminate", arg_tys: vec![Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "process::write_stdin", arg_tys: vec![Type::Any, Type::Any, Type::Bool], ret_ty: Type::Any },
        LspExtern { full_name: "process::read_output", arg_tys: vec![Type::Any], ret_ty: Type::Any },
        LspExtern { full_name: "stdio::read_line", arg_tys: vec![], ret_ty: Type::Any },
        LspExtern { full_name: "stdio::write_line", arg_tys: vec![Type::Any], ret_ty: Type::Bool },
