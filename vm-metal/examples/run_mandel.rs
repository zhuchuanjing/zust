...
fn main() -> Result<()> {
    ...
    let params_layout = vm::GpuStructLayout::from_symbol_table(&vm.jit.read().compiler.sym_tab.symbols, &format!("{module_name}::Params"), &[Type::ConstInt(BIGFLOAT_LIMBS as i64)])?;
