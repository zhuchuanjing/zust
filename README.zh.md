...
项目已经接近成熟的开源版本。当前 workspace 内各 crate 独立发版：VM crate 为 `0.9.106`，root crate 为 `0.9.26`，dynamic crate 为 `0.9.26`，compiler 为 `0.9.47`，parser 为 `0.9.26`，SPIR-V 后端为 `0.9.12`，Metal 后端为 `0.9.14`，编辑器相关包为 `0.9.2`。
